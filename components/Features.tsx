        ...
        <section className="relative z-10 bg-transparent py-16 sm:py-24" id="how-it-works">
            <div className="container mx-auto max-w-6xl px-6 md:px-4">
                <div className="mb-10 text-center sm:mb-16">
                    ...
                    <p className="mx-auto max-w-xl text-sm text-muted-foreground sm:text-base">Everything you need to scale your content production.</p>
                </div>
                        ...
                        >
                            <Card className="h-full bg-card/50 border-border hover:border-primary/50 transition-colors group relative overflow-hidden">
                                ...
                                <CardHeader className="p-5 sm:p-6">
                                    <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border border-border bg-black/40 transition-colors group-hover:bg-primary/10 sm:h-16 sm:w-16">
                                        {feature.icon}
                                    </div>
