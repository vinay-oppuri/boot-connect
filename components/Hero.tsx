    ...
    return (
        <section className="relative flex min-h-screen items-center overflow-hidden pt-24 pb-12 sm:pt-28 sm:pb-16">
            ...
            <div className="absolute inset-0 bg-[#050505] -z-20">
                ...
                <div className="absolute top-1/4 left-1/4 h-[320px] w-[320px] rounded-full bg-[#EFFF00]/5 blur-[120px] -z-10 sm:h-[500px] sm:w-[500px]"></div>
            ...
            <div className="container relative z-10 mx-auto flex flex-col items-center px-6 md:px-4 text-center">
                ...
                >
                    <Button size="lg" className="h-11 rounded-full px-6 text-sm font-bold shadow-[0_0_20px_rgba(239,255,0,0.4)] transition-all hover:shadow-[0_0_35px_rgba(239,255,0,0.6)] sm:h-12 sm:px-8 sm:text-base md:h-14 md:text-lg">
                        Hire an Editor
                    </Button>
                </motion.div>
            </div>
